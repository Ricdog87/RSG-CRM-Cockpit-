...
export const IMPORT_OBJECTS: ImportObject[] = [
  // ───────────────────────── Datensätze ─────────────────────────
  {
    ...
    fields: [
      ...
      { key: "strasse", label: "Straße & Nr.", hints: ["straße", "strasse", "street", "adresse", "address"], sample: "Musterstraße 1" },
      { key: "plz", label: "PLZ", hints: ["plz", "postleitzahl", "postal", "zip"], sample: "30159" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "location", label: "Ort", hints: ["ort", "stadt", "city", "standort", "wohnort"], sample: "Hannover" },
      { key: "zip", label: "PLZ", hints: ["plz", "postleitzahl", "zip", "postal"], sample: "30159" },
      { key: "current_employer", label: "Aktueller Arbeitgeber", hints: ["arbeitgeber", "employer", "firma", "company", "unternehmen"], sample: "Muster GmbH" },
      { key: "languages", label: "Sprachen", hints: ["sprachen", "languages", "language"], sample: "Deutsch, Englisch" },
      { key: "experience_years", label: "Berufserfahrung (Jahre)", type: "number", hints: ["erfahrung", "experience", "berufserfahrung", "jahre"], sample: "5" },
      { key: "birth_date", label: "Geburtsdatum", type: "date", hints: ["geburtsdatum", "geburt", "birth", "birthday", "dob"], sample: "1990-05-12" },
    ],
