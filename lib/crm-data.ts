...
function mapCandidate(r: Row): Candidate {
  return {
    ...
    availability_status: str(r.availability_status, "NEU"),
    seniority: str(r.seniority) || undefined,
    linkedin_url: str(r.linkedin_url) || undefined,
    verfuegbar_ab: str(r.verfuegbar_ab) || undefined,
    wechselmotivation: str(r.wechselmotivation) || undefined,
