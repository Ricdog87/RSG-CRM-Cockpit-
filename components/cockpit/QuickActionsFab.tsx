...
const ACTIONS: Action[] = [
  { label: "Lead-Analyse", href: "/cockpit/leads", icon: IconSpark, accent: "bg-brand-deep" },
  { label: "Verkaufschance", href: "/cockpit/sales?new=1", icon: IconTarget, accent: "bg-sky-deep" },
