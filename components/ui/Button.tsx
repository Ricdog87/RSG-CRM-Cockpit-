...
const variants: Record<Variant, string> = {
  primary:
    "bg-purple text-white hover:bg-purple-soft shadow-glow disabled:opacity-60",
  ghost:
    "border border-border bg-transparent text-ink hover:bg-elevated disabled:opacity-60",
